  ...
  <div className="pt-6">
    ...
    <div className="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
      ...
      <div className="mt-4 lg:mt-0 lg:row-span-3">
        ...
        <p className="text-3xl text-gray-900">${Math.floor(product.priceRange.minVariantPrice.amount)}</p>
      ...
      <div className="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        ...
        <div className="mt-10">
          ...
          <div className="mt-4 space-y-6">
            <p className="text-sm text-gray-600">This Blink Shirt was popularized by the famous band Blink-182, Sign up for our subscription service and be the first to get new, exciting colors, like our upcoming "Charcoal Gray" limited release.</p>
          </div>
        </div>
      </div>
    </div>
